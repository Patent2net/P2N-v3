...
Sphinx uses .. _reStructuredText: https://docutils.sourceforge.io/docs/user/rst/quickref.html as its markup language, and many of its strengths come from the power
