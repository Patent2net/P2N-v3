...
def autom_request_spliter_time(RequestOrig, directory):
    ...
    if 'RequestsAuto' not in os.listdir('..') or directory not in os.listdir('../RequestsAuto'):
    ...
    if toBeFound>2000:
        ...
        Need = False
    dateDeb = int(input ("please enter the stardate year for gathering you request"))
...
if __name__ == "__main__":
    autom_request_spliter_time('(TA="neural net" OR TA="machine learning" OR CPC=G06N) AND PN=WO', 'Autom')
